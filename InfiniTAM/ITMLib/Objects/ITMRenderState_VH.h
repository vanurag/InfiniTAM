	...
	namespace Objects
	{
		...
		*/
		...
		public:
			...
			ITMRenderState_VH(int noTotalEntries, const Vector2i & imgSize, float vf_min, float vf_max, const float start_time, MemoryDeviceType memoryType = MEMORYDEVICE_CPU)
				: ITMRenderState(imgSize, vf_min, vf_max, start_time, memoryType)
            {
