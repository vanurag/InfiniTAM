...
namespace ITMLib
{
	namespace Engine
	{
		...
		{
		public:
			void IntegrateGlobalIntoLocal(ITMScene<TVoxel, TIndex> *scene, ITMTrackingState *trackingState, ITMRenderState *renderState, const bool should_fuse) {}
		...
		public:
			void IntegrateGlobalIntoLocal(ITMScene<TVoxel, ITMVoxelBlockHash> *scene, const ITMView *view, ITMTrackingState *trackingState, ITMRenderState *renderState, const bool should_fuse);
